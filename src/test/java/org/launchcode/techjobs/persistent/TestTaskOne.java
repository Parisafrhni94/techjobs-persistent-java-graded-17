...
public class TestTaskOne extends AbstractTest{
    ...
    * */
    ...
    public void testDbConnectionProperties () throws IOException {
        ...
        Pattern urlPattern = Pattern.compile("spring.datasource.url=jdbc:mysql://localhost:8080/techjob");
        ...
        Pattern usernamePattern = Pattern.compile("spring.datasource.username=techjob");
        ...
        Pattern passwordPattern = Pattern.compile("spring.datasource.password=minoochehreh47");
